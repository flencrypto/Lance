...
DEFAULT_HEIGHT = 352
DEFAULT_WIDTH = 640
DEFAULT_T2V_DURATION_SECONDS = 8
DEFAULT_I2V_DURATION_SECONDS = 5
DEFAULT_VIDEO_DURATION_SECONDS = DEFAULT_T2V_DURATION_SECONDS
...
TASK_LABEL_TO_INTERNAL = {
    ...
    TASK_LABEL_IMAGE_TO_VIDEO: TASK_I2V,
...
VIDEO_TASKS = {TASK_T2V, TASK_I2V, TASK_VIDEO_EDIT, TASK_X2T_VIDEO}
